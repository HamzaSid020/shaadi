...
export interface MDTableBodyProps extends TableBodyProps {
...
const MDTableBody = styled(TableBody, {
  shouldForwardProp: (prop) =>
    ...
    prop !== 'shadow' &&
    prop !== 'coloredShadow',
})<MDTableBodyProps>(({ theme, variant, bgColor, color, opacity, borderRadius, shadow, coloredShadow }) => {
