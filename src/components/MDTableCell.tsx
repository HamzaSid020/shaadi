...
export interface MDTableCellProps extends TableCellProps {
...
const MDTableCell = styled(TableCell, {
  shouldForwardProp: (prop) =>
    ...
    prop !== 'shadow' &&
    prop !== 'coloredShadow',
})<MDTableCellProps>(({ theme, variant, bgColor, color, opacity, borderRadius, shadow, coloredShadow }) => {
