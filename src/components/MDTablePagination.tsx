...
export interface MDTablePaginationProps extends TablePaginationProps {
...
const MDTablePagination = styled(TablePagination, {
  shouldForwardProp: (prop) =>
    ...
    prop !== 'shadow' &&
    prop !== 'coloredShadow',
})<MDTablePaginationProps>(({ theme, variant, bgColor, color, opacity, borderRadius, shadow, coloredShadow }) => {
